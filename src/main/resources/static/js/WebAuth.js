...
export async function registerCredential(email, nombre) {
    try {
        ...
        // Paso 4: Preparar la respuesta serializada incluyendo clientExtensionResults
        const attestationResponse = {
            ...
            // ✅ Fix crítico: Envía un objeto vacío en lugar de null para evitar que Yubico falle al deserializar
...
export async function loginCredential(email) {
    try {
        ...
        // Paso 4: Preparar la firma para enviarla de vuelta al servidor incluyendo clientExtensionResults
        const assertionResponse = {
            ...
            // ✅ Previene el mismo error de deserialización estricta durante el inicio de sesión
